...
🌐 **Live Demo:**  
[https://aiapp-jjj1.onrender.com/index.html](https://aiapp-jjj1.onrender.com/index.html)
...
This application enables users to interact with an AI system through a web interface.  
User prompts are processed by the backend and sent to the Groq API, and responses are returned in real time.

All interactions are stored in a **managed cloud database (Aiven)**, ensuring persistence and scalability.
